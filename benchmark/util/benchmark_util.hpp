...
namespace abo::benchmark {
     ...
     * @param original The original function. As most metrics are symmetric, it can be swapped with the approximated function
     * for them. The only exceptions are the average case relative and worst case relative error
     * @param approx The approximated function. Must be an unsigned integer.
     * @param metric The metric to evaluate
     * @return The metric value. For the approximate metrics, it is the average between the lower and upper bound on the error
     */
     ...
     * @param par1 The first parameter of the approximate adder. This has different meanings for different adders
     * @param par2 (optional) The second parameter of the approximate adder. This has different meanings for different adders
     ...
     * @param bits The number of bits the adder should have
     * @param par1 The first parameter of the approximate adder. This has different meanings for different adders
     * @param par2 par2 (optional) The second parameter of the approximate adder. This has different meanings for different adders

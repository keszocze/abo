...
namespace abo::operators {
    ...
    /**
     * @brief subset_light_child Approximates the given BDD by setting one child of each node with a variable level
     * between level_start and level_end to 0. The child to subset is chosen as the one with the smaller ON-set as computed by abo::util::count_minterms
     ...
     * @param level_end The last variable level at which the approximation is applied (may be equal to level_start when approximating only one level)
    ...
    /**
     * @brief subset_light_child Approximates the given BDD by setting one child of each node with a variable level
     * between level_start and level_end to 1. The child to superset is chosen as the one with the larger ON-set as computed by abo::util::count_minterms
     * @param mgr The cudd object manager to create nodes in
     * @param bdd The bdd to approximate
     * @param level_start The variable level to start approximating from
     * @param level_end The last variable level at which the approximation is applied (may be equal to level_start when approximating only one level)
    ...
    /**
     * @brief subset_light_child Approximates the given BDD by setting one child of each node with a variable level
     * between level_start and level_end to 1. The child to superset is chosen as the one with the smaller ON-set as computed by abo::util::count_minterms
     * @param mgr The cudd object manager to create nodes in
     * @param bdd The bdd to approximate
     * @param level_start The variable level to start approximating from
     * @param level_end The last variable level at which the approximation is applied (may be equal to level_start when approximating only one level)
    ...
    /**
     * @brief subset_light_child Approximates the given BDD by setting one child of each node with a variable level
     * between level_start and level_end to 0. The child to subset is chosen as the one with the larger ON-set as computed by abo::util::count_minterms
     * @param mgr The cudd object manager to create nodes in
     * @param bdd The bdd to approximate
     * @param level_start The variable level to start approximating from
     * @param level_end The last variable level at which the approximation is applied (may be equal to level_start when approximating only one level)
    ...
    /**
     * @brief New operation introduced for testing purposes. Like for example subset_light_child, it chooses one child for each node to replace
     * by a terminal node, but it chooses the child and the corresponding terminal to minimize the resulting error rate
     * @param mgr The cudd object manager to create nodes in
     * @param bdd The bdd to approximate
     * @param level_start The variable level to start approximating from
     * @param level_end The last variable level at which the approximation is applied (may be equal to level_start when approximating only one level)

...
namespace abo::minimization {
    ...
    //! A simplified version of the struct MetricDimension with an enum for the metric instead of a lambda
    ...
    //! Stores a configuration for easily running simple tests with the bucket based minimization algorithm

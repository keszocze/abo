...
int main()
{
    cout << "Original size, smallest size found, corresponding error rate, corresponding average "
            "case error, minimzation time"
         << endl;
    ...
    for (auto [bits, ace_limit] : parameters)
    {
        ...
        cout << result.original_size << ", " << result.smallest_function.bdd_size << ", "
             ...
             << abo::minimization::format_time(result.minimization_time) << endl;
